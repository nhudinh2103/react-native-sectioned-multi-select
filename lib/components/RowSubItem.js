...
class RowSubItem extends Component {
  ...
  render() {
    ...
    const shouldUseCustomRenderer = CustomSubItemContentRenderer ? true : false;
  ...
  >
    ...
    {!shouldUseCustomRenderer && this._renderDefaultContent()}

    {shouldUseCustomRenderer &&
      <CustomSubItemContentRenderer subItem={subItem} isItemSelected={itemSelected}/>}
